  ...
  return (
    <div className='flex w-full min-h-screen  justify-center items-center'>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 text-white  my-3 gap-4">
          <div>
            <label htmlFor="price">Price</label>
            <input type="text" name='price' id='price' className='border border-slate-300 text-white w-full py-1 px-3' />
          </div>
          <div>
            <label htmlFor="vehicles">Status</label>
            <select name="" id="vehicles" className='border border-slate-300 text-white w-full py-1 px-3'>
              <option value=""></option>
            </select>
          </div>
          <div>
            <label htmlFor="price">Customer</label>
            <input type="text" name='price' id='price' className='border border-slate-300 text-white w-full py-1 px-3' />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 text-white  my-3 gap-4">
          <div>
            <label htmlFor="price">Driver</label>
            <input type="text" name='price' id='price' className='border border-slate-300 text-white w-full py-1 px-3' />
          </div>
          <div>
            <label htmlFor="price">Booking start Date</label>
            <input type="text" name='price' id='price' className='border border-slate-300 text-white w-full py-1 px-3' />
          </div>
          <div>
            <label htmlFor="price">Driver</label>
